...
const ToolsCatalog = [
  {
    ...
    description:
      'A flexible tool for interacting with objects from RERUM, allowing users to experiment with data.',
  },
  {
    ...
    description:
      'Helps users annotate data with geolocation coordinates by selecting points on a map.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Allows users to transcribe manuscripts by aligning text with scanned images for research and accuracy.',
  },
  {
    label: 'Adno',
    ...
    description:
      'A tool for viewing and editing IIIF and static images within archives and heritage collections.',
  },
  {
