...
const config = {
  title: 'RERUM Playground HTML Documentation',
  tagline: 'In-depth explanations of html files within the RERUM Playground website.',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'HTML Documentation for RERUM',
        logo: {
          alt: 'My Site Logo',
          src: 'img/logo.svg',
        },
